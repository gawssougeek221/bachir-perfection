...
export default function CTA() {
  ...
  useEffect(() => {
    ...
    // Magnetic button
    const btn = sectionRef.current.querySelector(".cta-magnetic");
    if (btn) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-20 right-1/3 w-px h-16 bg-gradient-to-b from-transparent via-[#D4AF37]/10 to-transparent hidden md:block" />
      <div className="absolute bottom-24 left-1/3 w-px h-16 bg-gradient-to-b from-[#D4AF37]/10 via-transparent to-transparent hidden md:block" />

      <div className="max-w-2xl mx-auto text-center relative">
        {/* Gold decorative */}
        <div className="cta-reveal flex items-center justify-center gap-3 mb-12">
        ...
        <div className="cta-reveal mt-12">
          <a
            ...
            className="cta-magnetic inline-flex items-center gap-3 px-10 py-5 bg-[#D4AF37] text-[#111] rounded-full hover:bg-[#C4A030] transition-colors duration-300 text-sm tracking-wider uppercase font-semibold shadow-lg shadow-[#D4AF37]/15"
            data-cursor="pointer"
            data-cursor-text="GO"
          >
            <svg
