...
export default function Hero3D() {
  ...
  return (
    ...
    >
      {/* 3D Car Canvas - covers the full hero, car is centered & large */}
      <div className="absolute inset-0 z-[2]">
        <Canvas
          camera={{ position: [5, 2.5, 8], fov: 28 }}
          shadows
          dpr={[1, 2]}
      ...
      {/* Text overlay - LEFT SIDE ONLY, starts at 20% from top */}
      <div className="absolute top-[20%] left-0 z-[4] px-6 md:px-12 lg:px-20 pointer-events-none">
        <div className="max-w-md lg:max-w-lg pointer-events-auto">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-[#111] leading-[1.08]">
          ...
          <p className="hero-subtitle text-xs md:text-sm text-[#555] mt-4 md:mt-6 max-w-xs leading-relaxed">
          ...
          <div className="flex flex-col gap-3 md:gap-4 mt-6 md:mt-8 w-fit pointer-events-auto">
            ...
            <a
              ...
              className="hero-btn-2 inline-flex items-center justify-center gap-2 bg-white/90 backdrop-blur-sm text-[#333] px-6 md:px-8 py-3 md:py-3.5 rounded-[25px] text-[11px] md:text-sm tracking-wider uppercase font-medium border border-[#D4AF37]/60 hover:border-[#D4AF37] hover:text-[#D4AF37] transition-all duration-300"
            >
